import { isEndKey, isEnterKey, isEscapeKey, isHomeKey, isPageDownKey, isPageUpKey, isSpaceKey, isTabKey } from "./helpers";
/**
 * Convert a {@link KeyboardEvent} into a {@link KeyboardShortcut}
 * @param event - KeyboardEvent
 * @returns The corresponding {@link KeyboardShortcut}
 */
export function keyboardShortcutFromKeyboardEvent(event) {
    const { key } = event;
    if (event.shiftKey) {
        switch (key) {
            case ' ':
