...
const Field = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ae0a6c7224dc199cd6cd342d77878bfff17aa49b' }, index.h("slot", { key: '408c146f3e6bfa1868964a29934494215627fb59', name: "label" }), index.h("slot", { key: '9c2151491f6acc4a5a6da36676e21e8dee6f156a', name: "content" })));
    }
};
