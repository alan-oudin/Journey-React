...
const WcsTooltipStyle0 = tooltipCss;
...
const Tooltip = class {
    ...
    onShow() {
        ...
        if (this.forElement.tagName && DELEGATED_ARIA_COMPONENTS.indexOf(this.forElement.tagName) !== -1) {
            if (mutableAriaAttribute.isMutableAriaAttribute(this.forElement)) {
                if (this.interactive) {
    ...
    render() {
        return (index.h(index.Host, { key: '34f019e113250ce19d69186080c932f838ac5c86', role: "tooltip" }, index.h("slot", { key: '7edce2cfc96d454177668c81d615231369600977', onSlotchange: _ => this.updateTippyContent() })));
    }
...
Tooltip.style = WcsTooltipStyle0;
