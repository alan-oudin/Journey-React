...
const Alert = class {
    constructor(hostRef) {
        ...
        this.wcsAlertDismiss = index.createEvent(this, "wcsAlertDismiss", 7);
    ...
    render() {
        return (index.h(index.Host, { key: '82c9f5879eae7adef41c921ef34b2b9d891c0d6b' }, index.h("div", { key: 'b46424dfb6b620b62767b6bb8048827f83d116a7', class: "icon-content-container" }, index.h("wcs-mat-icon", { key: 'ff3a0bc91a73e275936bbe8f77c904f397296551', class: "announcement-icon", ref: (el) => this.annoucementIconHtmlElement = el, icon: this.getMaterialIcon(), "aria-label": this.getAriaLabel(), role: "img", "aria-hidden": false }), index.h("div", { key: 'ea866940416ddaf5eaf73cec83f30c71b01c41d8', class: "content" }, index.h("slot", { key: 'd14c321ebdb78b646bb4fc19e613dbd2cc61ed31', name: "title" }), index.h("slot", { key: '569d6556ea823f82e1d6164ac20361e27c85b592', name: "subtitle" }))), index.h("wcs-button", { key: 'f13afc31116b7b6fe04e0186128d0288725ace98', shape: "round", size: "s", mode: "clear", class: "close-button wcs-dark", "aria-label": "Fermer cette notification", onClick: ($event) => this.onCloseButtonClick($event) }, index.h("wcs-mat-icon", { key: '02557c896159ec1a7fdab853a07f7c79c17dd5d7', icon: "close" })), index.h("div", { key: '9e90e95009da575ca693e5ba4e92b3916ad4ee6f', class: 'progress-bar' + (!this.showProgressBar ? ' hidden' : '') }, index.h("div", { key: 'c8858551592bb0b1622e2ee19c67a662f31ce068', class: "progress-bar-track" }))));
    }
    get el() { return index.getElement(this); }
};
Alert.style = WcsAlertStyle0;

exports.wcs_alert = Alert;

//# sourceMappingURL=wcs-alert.cjs.entry.js.map