...
const Radio = class {
    ...
    async setAriaAttribute(attr, value) {
        helpers.setOrRemoveAttribute(this.nativeRadio, attr, value);
    }
    onFocus(ev) {
