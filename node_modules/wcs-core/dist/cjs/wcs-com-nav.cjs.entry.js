...
const ComNav = class {
    ...
    componentWillLoad() {
        this.inheritedAttributes = Object.assign(Object.assign({}, helpers.inheritAriaAttributes(this.el)), helpers.inheritAttributes(this.el, COM_NAV_INHERITED_ATTRS));
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b39ff3dbd6d304ad0252e0fcfd2e0c5716b666db' }, index.h("div", { key: 'f84b73c9cee6295a7776576afeb61b65b71ea34e', class: "container" }, index.h("div", { key: 'a39b867e9d102abb4e4c13503a544681cd9b7fd8', class: "container-left" }, index.h("div", { key: '49db5dd80f097a9b2ccaf39fc64be9f6100108be', class: "app-name" }, this.appName, index.h("slot", { key: '2936888d5a805c67a3be4079a7eea62d460d42fe', name: "app-name" })), this.currentActiveSizing === 'desktop' ?
            index.h("nav", Object.assign({ role: "navigation" }, this.inheritedAttributes), index.h("div", { class: "menu-bar", role: "list" }, this.currentActiveSizing === 'desktop'
                ? index.h("slot", null)
                : null))
            : null), index.h("div", { key: 'c2c97d21d21d542a18fb141f90ce7ce91d0b12c0', class: "container-right" }, index.h("slot", { key: '51912b232ac4d51baf1d2c164e90ab59a787924e', name: "actions" }), this.currentActiveSizing === 'mobile' ?
            index.h("nav", Object.assign({ id: "wcs-com-nav-mobile-menu", role: "navigation" }, this.inheritedAttributes), index.h("button", { id: "mobile-menu-icon", "aria-label": menuAriaLabel, "aria-expanded": this.mobileMenuOpen ? "true" : "false", "aria-controls": "wcs-com-nav-mobile-menu", onClick: () => this.mobileMenuIconClick() }), this.currentActiveSizing === 'mobile'
                ? index.h("div", { class: "mobile-overlay", "data-mobile-open": this.mobileMenuOpen, role: "list" }, index.h("slot", null))
                : null)
            : null))));
    }
    /**
