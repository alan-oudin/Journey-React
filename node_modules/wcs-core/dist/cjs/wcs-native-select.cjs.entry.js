...
const NativeSelect = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dedd08d93118cc5323b6d2062577275504972b12', class: `${this.expanded ? 'expanded' : ''}`, "data-disabled": this.disabled, "data-size": this.size }, index.h("div", { key: 'bd211e20d0ab314767729ab54611c3d28fb8cca7', class: "select-wrapper" }, index.h("slot", { key: 'b0e58a954d0212c19a05395065ad5ed76efa9f39' }), index.h("div", { key: '5f70166ee1756180982a43151b9762e1cfec51d4', class: "arrow-container" }, index.h(selectArrow.SelectArrow, { key: 'ed256e18a87ab7cf17af6b5226ee6f10779d5bb1', up: this.expanded })))));
    }
