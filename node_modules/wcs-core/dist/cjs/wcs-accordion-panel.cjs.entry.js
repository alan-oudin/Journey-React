...
const WcsAccordionPanelStyle0 = accordionPanelCss;
...
const AccordionPanel = class {
    ...
    componentWillLoad() {
        this.inheritedAttributes = Object.assign(Object.assign({}, helpers.inheritAriaAttributes(this.el)), helpers.inheritAttributes(this.el, ACCORDION_INHERITED_ATTRS));
    }
