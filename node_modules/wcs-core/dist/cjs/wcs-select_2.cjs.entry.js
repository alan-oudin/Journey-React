...
const Select = class {
    ...
    updateSelectedValue(value, resetIfNoValue = true) {
        ...
        if (this.multiple) {
            ...
            if (this.serverMode) {
                ...
                const compareResult = helpers.compareLists(this.values.map(v => v.value), value, this.compareWith);
    ...
    componentWillLoad() {
        ...
        if (this.autocomplete) {
            this.inheritedAttributes = Object.assign(Object.assign({}, helpers.inheritAriaAttributes(this.el)), helpers.inheritAttributes(this.el, SELECT_INHERITED_ATTRS));
        }
    }
    async setAriaAttribute(attr, value) {
        if (this.autocomplete === false) {
            ...
            helpers.setOrRemoveAttribute(this.autocompleteInput, attr, value);
        }
    }
    get options() {
        var _a;
...
const SelectOption = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8e2f93d1db10d33df62a34b1f9e62a948a78424e', id: this.selectOptionId, "aria-selected": this.selected || this.highlighted ? 'true' : 'false', slot: "options", role: "option", tabindex: "-1" }, this.multiple &&
            index.h("wcs-checkbox", { key: '3af49da773954213d7f2b64c4a2f8fd7114b6a24', tabindex: "-1", checked: this.selected, disabled: this.disabled }), index.h("slot", { key: '3e5267f2626863b13bbcab46f98b4eacfa90c83f' })));
    }
    get el() { return index.getElement(this); }
};
