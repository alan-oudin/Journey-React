...
const ComNavItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '25690c3eecac76d2b29b0aeda90f5e1bf5fd0b22', role: "listitem" }, index.h("slot", { key: '236d67ffd9fefb7650d2b67cee685852030adb4b' }), index.h("span", { key: '2ef478d77dc28d169817500145c8d9df525bd439', class: "arrow-container" }, index.h("span", { key: '0fafbba11e817663ad7e18ff6947cdbd07494f69', "aria-hidden": "true", class: "arrow-icon" }, "\uF107"))));
    }
};
ComNavItem.style = WcsComNavItemStyle0;

exports.wcs_com_nav_item = ComNavItem;

//# sourceMappingURL=wcs-com-nav-item.cjs.entry.js.map