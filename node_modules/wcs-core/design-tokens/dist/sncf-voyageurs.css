...
.sncf-voyageurs {
  ...
  --wcs-primitive-color-backdrop: rgba(0, 43, 40, 0.4);
  --wcs-primitive-color-vert-100: #f7fdf6;
  --wcs-primitive-color-vert-200: #e7fce5;
  --wcs-primitive-color-vert-300: #d3ffcf;
  --wcs-primitive-color-vert-400: #bbffbe; /* Vert Raisin */
  --wcs-primitive-color-vert-500: #34e88e; /* Vert Primavera */
  --wcs-primitive-color-vert-600: #00856b;
  --wcs-primitive-color-vert-700: #065654; /* Vert Pin */
  --wcs-primitive-color-vert-800: #043e3d;
  --wcs-primitive-color-vert-900: #002b28; /* Vert Jaspe */
  --wcs-primitive-color-bleu-100: #eff8ff;
  --wcs-primitive-color-bleu-200: #dff2ff;
  --wcs-primitive-color-bleu-300: #b0dfff; /* Bleu Polaire */
  --wcs-primitive-color-bleu-400: #3390ff; /* Bleu Azur */
  --wcs-primitive-color-bleu-500: #00468c; /* Bleu Ocean */
  --wcs-primitive-color-bleu-600: #002346; /* Bleu Nuit */
  --wcs-primitive-color-jaune-100: #fffdf5;
  --wcs-primitive-color-jaune-200: #fff9dd;
  --wcs-primitive-color-jaune-300: #ffefab; /* Jaune Sable */
  --wcs-primitive-color-jaune-400: #ffd245; /* Jaune Soleil */
  --wcs-primitive-color-jaune-500: #664400; /* Marron Roche */
  --wcs-primitive-color-orange-100: #fff6f0; /* Orange Bisque */
  --wcs-primitive-color-orange-200: #ffd2a9; /* Ocre Rocheuse */
  --wcs-primitive-color-orange-300: #ff6833; /* Orange Sanguinaire */
  --wcs-primitive-color-orange-400: #7c1a00; /* Rouge Basque */
  ...
  --wcs-semantic-color-border-secondary: rgba(6, 86, 84, 0.2); /* Secondary border color */
  ...
  --wcs-primitive-color-primary: var(--wcs-primitive-color-vert-700);
  ...
  --wcs-semantic-border-radius-base: var(--wcs-primitive-size-120); /* Base border-radius */
  ...
  --wcs-semantic-color-border-warning: var(--wcs-primitive-color-jaune-400); /* Warning border color */
  --wcs-semantic-color-border-information: var(--wcs-primitive-color-bleu-500); /* Information border color */
  --wcs-semantic-color-border-success: var(--wcs-primitive-color-vert-500); /* Success border color */
  --wcs-semantic-color-border-action-secondary-hover: var(--wcs-primitive-color-vert-900); /* Hover border color for secondary elements like button, dropdown... */
  --wcs-semantic-color-border-action-secondary-press: var(--wcs-primitive-color-vert-900); /* Pressed border color for secondary elements like button, dropdown... */
  ...
  --wcs-semantic-color-border-focus-base: var(--wcs-primitive-color-vert-900); /* Border color on focus for base elements like button, dropdown, counter, switch... */
  ...
  --wcs-semantic-color-border-control-indicator-hover: var(--wcs-primitive-color-vert-800); /* Hovered border color of a form-field indicator: radio, checkbox */
  ...
  --wcs-semantic-color-background-action-primary-hover: var(--wcs-primitive-color-vert-800); /* Can be used by primary elements which must have a hover state (button, dropdown...) */
  --wcs-semantic-color-background-action-primary-press: var(--wcs-primitive-color-vert-900); /* Can be used by primary elements which must have a press state (nav-item) */
  --wcs-semantic-color-background-action-primary-selected-default: var(--wcs-primitive-color-vert-900); /* Can be used by primary elements which must have a selected state (nav-item) */
  --wcs-semantic-color-background-action-primary-selected-hover: var(--wcs-primitive-color-vert-900); /* Can be used by primary elements which must have a hover state while selected (nav-item) */
  --wcs-semantic-color-background-action-primary-selected-press: var(--wcs-primitive-color-vert-900); /* Can be used by primary elements which must have a hover state while pressed (nav-item) */
  ...
  --wcs-semantic-color-background-action-information-default: var(--wcs-primitive-color-bleu-500); /* Default information background color */
  --wcs-semantic-color-background-action-information-hover: var(--wcs-primitive-color-bleu-600); /* Hovered information background color */
  --wcs-semantic-color-background-action-information-press: var(--wcs-primitive-color-bleu-600); /* Pressed information background color */
  ...
  --wcs-semantic-color-background-action-success-default: var(--wcs-primitive-color-vert-700); /* Default success background color */
  --wcs-semantic-color-background-action-success-hover: var(--wcs-primitive-color-vert-800); /* Hovered success background color */
  --wcs-semantic-color-background-action-success-press: var(--wcs-primitive-color-vert-900); /* Pressed success background color */
  ...
  --wcs-semantic-color-background-action-warning-default: var(--wcs-primitive-color-jaune-400); /* Default warning background color */
  --wcs-semantic-color-background-action-warning-hover: var(--wcs-primitive-color-jaune-500); /* Hovered warning background color */
  --wcs-semantic-color-background-action-warning-press: var(--wcs-primitive-color-jaune-500); /* Pressed warning background color */
  ...
  --wcs-semantic-color-background-control-indicator-hover: var(--wcs-primitive-color-vert-800); /* Hovered background color of a form-field indicator: radio, checkbox */
  ...
  --wcs-semantic-color-background-surface-information-default: var(--wcs-primitive-color-bleu-500); /* Default information background color */
  ...
  --wcs-semantic-color-background-surface-success-default: var(--wcs-primitive-color-vert-700); /* Default success background color */
  ...
  --wcs-semantic-color-background-surface-warning-default: var(--wcs-primitive-color-jaune-400); /* Default warning background color */
  --wcs-semantic-color-background-surface-warning-light: var(--wcs-primitive-color-jaune-300); /* Light warning background color */
  --wcs-semantic-color-background-surface-warning-lighter: var(--wcs-primitive-color-jaune-200); /* Lighter warning background color */
  --wcs-semantic-color-background-surface-warning-lightest: var(--wcs-primitive-color-jaune-100); /* Lightest warning background color */
  --wcs-semantic-color-background-surface-accent-light: var(--wcs-primitive-color-vert-300); /* Light accent background color, used by nav-item indicator and grid rows */
  --wcs-semantic-color-background-surface-accent-lighter: var(--wcs-primitive-color-vert-200); /* Lighter accent background color, used by grid rows and segmented-button background (radio options) */
  --wcs-semantic-color-background-surface-accent-lightest: var(--wcs-primitive-color-vert-100); /* Lightest accent background color, used by segmented-button background (radio options) */
  --wcs-semantic-color-background-surface-accent-dark: var(--wcs-primitive-color-vert-600); /* Dark accent background color */
  --wcs-semantic-color-background-surface-accent-darker: var(--wcs-primitive-color-vert-700); /* Darker accent background color */
  --wcs-semantic-color-background-surface-accent-darkest: var(--wcs-primitive-color-vert-800); /* Darkest accent background color */
  ...
  --wcs-semantic-color-foreground-warning: var(--wcs-primitive-color-jaune-500); /* Warning foreground color */
  --wcs-semantic-color-foreground-information: var(--wcs-primitive-color-bleu-500); /* Information foreground color */
  --wcs-semantic-color-foreground-success: var(--wcs-primitive-color-vert-500); /* Success foreground color */
  --wcs-semantic-color-foreground-on-accent: var(--wcs-primitive-color-vert-900); /* Foreground color on top of an accent background */
  --wcs-semantic-color-foreground-inverse: var(--wcs-primitive-color-neutral-800); /* Inverse foreground for contrast (mostly black) */
  --wcs-semantic-color-foreground-action-secondary-hover: var(--wcs-primitive-color-vert-900); /* The layer on top of a secondary background when hovered */
  --wcs-semantic-color-foreground-action-secondary-press: var(--wcs-primitive-color-vert-900); /* The layer on top of a secondary background when pressed */
  --wcs-semantic-color-foreground-action-tertiary-hover: var(--wcs-primitive-color-vert-900); /* The layer on top of a tertiary background when hovered */
  --wcs-semantic-color-foreground-action-tertiary-press: var(--wcs-primitive-color-vert-900); /* The layer on top of a tertiary background when pressed */
  ...
  --wcs-semantic-color-text-link-hover: var(--wcs-primitive-color-vert-900); /* Hovered text color for link */
...
.sncf-voyageurs wcs-switch {
    --wcs-switch-dot-color-default: var(--wcs-primitive-color-neutral-600);
    --wcs-switch-dot-color-selected: var(--wcs-primitive-color-vert-300);
    --wcs-switch-dot-color-disabled: var(--wcs-primitive-color-neutral-600);
}

.sncf-voyageurs wcs-footer {
    --wcs-footer-background-color: var(--wcs-primitive-color-vert-700);
}

.sncf-voyageurs wcs-galactic {
    --wcs-galactic-background-color: var(--wcs-primitive-color-vert-900);
}

.sncf-voyageurs wcs-galactic-menu {
    --wcs-semantic-color-border-focus-base: var(--wcs-semantic-color-border-focus-base-on-secondary);
}

/* wcs-tooltip */
.sncf-voyageurs .tippy-box[data-theme~='dark'] {
...
.sncf-voyageurs .wcs-success {
    --wcs-semantic-color-background-action-primary-default: var(--wcs-primitive-color-vert-700);
    --wcs-semantic-color-background-surface-brand: var(--wcs-primitive-color-vert-700);

    --wcs-semantic-color-foreground-action-primary-default: var(--wcs-primitive-color-neutral-0);
    --wcs-semantic-color-foreground-action-secondary-default: var(--wcs-primitive-color-vert-700);
    --wcs-semantic-color-foreground-action-tertiary-default: var(--wcs-primitive-color-vert-700);

    --wcs-semantic-color-border-action-secondary-default: var(--wcs-primitive-color-vert-700);

    --wcs-semantic-color-ripple-action-primary: var(--wcs-primitive-color-neutral-0);
    --wcs-semantic-color-ripple-action-secondary: var(--wcs-primitive-color-vert-700);
    --wcs-semantic-color-ripple-action-tertiary: var(--wcs-primitive-color-vert-700);
}

.sncf-voyageurs .wcs-warning {
    --wcs-semantic-color-background-action-primary-default: var(--wcs-primitive-color-jaune-400);
    --wcs-semantic-color-background-surface-brand: var(--wcs-primitive-color-jaune-400);
    ...
    --wcs-semantic-color-foreground-action-secondary-default: var(--wcs-primitive-color-jaune-400);
    --wcs-semantic-color-foreground-action-tertiary-default: var(--wcs-primitive-color-jaune-400);

    --wcs-semantic-color-border-action-secondary-default: var(--wcs-primitive-color-jaune-400);

    --wcs-semantic-color-ripple-action-primary: var(--wcs-primitive-color-neutral-800);
    --wcs-semantic-color-ripple-action-secondary: var(--wcs-primitive-color-jaune-400);
    --wcs-semantic-color-ripple-action-tertiary: var(--wcs-primitive-color-jaune-400);
}

.sncf-voyageurs .wcs-info {
    --wcs-semantic-color-background-action-primary-default: var(--wcs-primitive-color-bleu-500);
    --wcs-semantic-color-background-surface-brand: var(--wcs-primitive-color-bleu-500);

    --wcs-semantic-color-foreground-action-primary-default: var(--wcs-primitive-color-neutral-0);
    --wcs-semantic-color-foreground-action-secondary-default: var(--wcs-primitive-color-bleu-500);
    --wcs-semantic-color-foreground-action-tertiary-default: var(--wcs-primitive-color-bleu-500);

    --wcs-semantic-color-border-action-secondary-default: var(--wcs-primitive-color-bleu-500);

    --wcs-semantic-color-ripple-action-primary: var(--wcs-primitive-color-neutral-0);
    --wcs-semantic-color-ripple-action-secondary: var(--wcs-primitive-color-bleu-500);
    --wcs-semantic-color-ripple-action-tertiary: var(--wcs-primitive-color-bleu-500);
}

.sncf-voyageurs .wcs-critical {
    --wcs-semantic-color-background-action-primary-default: var(--wcs-primitive-color-critical-500);
    --wcs-semantic-color-background-surface-brand: var(--wcs-primitive-color-critical-500);
    ...
    --wcs-semantic-color-foreground-action-primary-default: var(--wcs-primitive-color-neutral-0);
    --wcs-semantic-color-foreground-action-secondary-default: var(--wcs-primitive-color-critical-500);
    --wcs-semantic-color-foreground-action-tertiary-default: var(--wcs-primitive-color-critical-500);

    --wcs-semantic-color-border-action-secondary-default: var(--wcs-primitive-color-critical-500);

    --wcs-semantic-color-ripple-action-primary: var(--wcs-primitive-color-neutral-0);
    --wcs-semantic-color-ripple-action-secondary: var(--wcs-primitive-color-critical-500);
    --wcs-semantic-color-ripple-action-tertiary: var(--wcs-primitive-color-critical-500);
}

/* wcs-danger is deprecated, use wcs-critical instead */
.sncf-voyageurs .wcs-danger {
    --wcs-semantic-color-background-action-primary-default: var(--wcs-primitive-color-critical-500);
    --wcs-semantic-color-background-surface-brand: var(--wcs-primitive-color-critical-500);
